...
\item \textbf{Full MCMC estimation:} The native \texttt{cfm\_fR} gravity model is now implemented in hi\_class (Section~\ref{sec:numerical}). The remaining step is a full MCMC parameter estimation over $(\alpha_{M,0}, n, \omega_{\mathrm{cdm}}, A_s, n_s)$ using Cobaya or emcee, and predictions for the nonlinear matter power spectrum $P(k)$.
