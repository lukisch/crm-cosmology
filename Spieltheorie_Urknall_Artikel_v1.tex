...
\textbf{Implikation f\"ur die Strukturbildung:} Ein sp\"aterer Beginn der kosmischen Beschleunigung ($z_{\mathrm{acc}} = 0{,}52$ statt $0{,}84$) bedeutet, dass gravitativ gebundene Strukturen (Galaxienhaufen, gro\ss{}r\"aumige Filamente) \textit{l\"anger ungest\"ort wachsen konnten}, bevor die Beschleunigung das Wachstum unterdr\"uckte. Dies k\"onnte erkl\"aren, warum Beobachtungen wiederholt massivere Strukturen bei hohen Rotverschiebungen finden als von $\Lambda$CDM vorhergesagt -- ein bekanntes Problem des Standardmodells. Die CFM-Vorhersage ist direkt testbar durch Galaxienhaufen-Z\"ahlungen und schwache Gravitationslinsen-Surveys (Euclid, Vera C.\ Rubin Observatory).
...
\textbf{3.~Strukturwachstum:} Eine modifizierte Wachstumsrate $f \cdot \sigma_8$ ist vorhergesagt, messbar durch schwache Gravitationslinsen und Galaxienhaufen-Z\"ahlungen.
...
\item Das CFM macht testbare Vorhersagen: eine durchgehende Phantom-Zustandsgleichung $w(z) < -1$ und einen fr\"uheren Beschleunigungs\"ubergang ($z_{\mathrm{acc}} = 0{,}52$ vs.\ $0{,}84$ in $\Lambda$CDM), die mit Euclid und Roman innerhalb der n\"achsten Dekade \"uberpr\"ufbar sind.
