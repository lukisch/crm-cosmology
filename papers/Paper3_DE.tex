...
\begin{enumerate}
\item \textbf{Urknall:} Entstehung der Raumzeitblase aus dem Nullraum (Vakuumnukleation).
...
\item \textbf{Ferne Zukunft:} Volle S\"attigung $\Omega_\Phi \to \Phi_0$ -- das Gleichgewicht ist erreicht, der Nullraumgradient ist neutralisiert, und die Expansion n\"ahert sich dem de-Sitter-Zustand.
\end{enumerate}
