...
\begin{equation}
{H^2(a) = H_0^2 \left[\Omega_b\,a^{-3} + \underbrace{\Phi_0 \cdot f_{\mathrm{sat}}(a)}_{\text{geometrische DE}} + \underbrace{\alpha \cdot a^{-\beta}}_{\text{geometrische DM}}\right]}
